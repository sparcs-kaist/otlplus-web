...
export const getTypeOptions = () => [
  ...
  ['BR', i18n.t('ui.type.basicRequiredShort')],
  ['BE', i18n.t('ui.type.basicElectiveShort')],
  ['MR', i18n.t('ui.type.majorRequiredShort')],
  ['ME', i18n.t('ui.type.majorElectiveShort')],
  ['MGC', i18n.t('ui.type.mandatoryGeneralCourseShort')],
  ['HSE', i18n.t('ui.type.humanitiesSocialElectiveShort')],
  ['GR', i18n.t('ui.type.generalRequiredShort')],
  ['EG', i18n.t('ui.type.electiveGraduateShort')],
...
export const getDepartmentOptions = () =>
  [
    ...
    ['IE', i18n.t('ui.department.ieShort'), 500],
    ['ID', i18n.t('ui.department.idShort'), 500],
    ['BS', i18n.t('ui.department.bsShort'), 500],
    ['MAS', i18n.t('ui.department.masShort'), 500],
    ['NQE', i18n.t('ui.department.nqeShort'), 500],
    ['EE', i18n.t('ui.department.eeShort'), 500],
    ['CS', i18n.t('ui.department.csShort'), 500],
    ['AE', i18n.t('ui.department.aeShort'), 500],
    ['CH', i18n.t('ui.department.chShort'), 500],

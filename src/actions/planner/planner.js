...
export const SET_COURSE_TO_ADD = BASE_STRING + 'SET_COURSE_TO_ADD';
export const SET_IS_TRACK_SETTINGS_SECTION_OPEN =
  BASE_STRING + 'SET_IS_TRACK_SETTINGS_SECTION_OPEN';
...
export function setCourseToAdd(course) {
  return {
    type: SET_COURSE_TO_ADD,
    course: course,
  };
}

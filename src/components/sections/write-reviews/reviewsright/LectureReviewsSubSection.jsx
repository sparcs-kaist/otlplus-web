...
class LectureReviewsSubSection extends Component {
  ...
  _fetchLectureRelatedReviews = () => {
    ...
    axios
      .get(`/api/lectures/${reviewsFocus.lecture.id}/related-reviews`, {
        params: {
  ...
  render() {
    ...
    return (
      <div className={classNames('subsection', 'subsection--flex', 'subsection--various-reviews')}>
        ...
        <Scroller key={reviewsFocus.lecture.id} expandTop={12}>
...
export default withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(LectureReviewsSubSection),
);

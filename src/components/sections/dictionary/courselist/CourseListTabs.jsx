...
import { openSearch, closeSearch } from '../../../../redux/actions/dictionary/search';
import { setSelectedListCode, setListCourses } from '../../../../redux/actions/dictionary/list';
...
class CourseListTabs extends Component {
  ...
  changeTab = (listCode) => {
    const { lists, setSelectedListCodeDispatch, openSearchDispatch, closeSearchDispatch } =
      this.props;
